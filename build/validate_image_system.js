...
const EXPECTED = Object.freeze({ assets: 48, products: 319, industries: (Array.isArray(require("./data/industries.json"))?require("./data/industries.json"):require("./data/industries.json").industries).length, v3Pilot: 12 });
